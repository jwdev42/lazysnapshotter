...
class TestMounts(unittest.TestCase):
	def test_getBlockDeviceFromUUID(self):
		...
		if not base.exists():
			raise Exception(f'Your dynamic device manager does not provide the directory "{str(base)}"')
		...
		self.assertIsNone(mounts.getBlockDeviceFromUUID('12345678-1234-1234-1234-123456789abc'))
